                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <a href="#" class="flex items-center">
                            ...
                            <img src ="/images/logo-mg-white.png" class="w-64">
                            </span>
                        </a>
                    </div>
                    <div class="hidden md:block">
                        <div class="mx-10 flex items-baseline">
                            <a href="#"
                               class="px-3 py-2 rounded-md text-sm font-medium text-white bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700">Homes</a>
                            <a href="#"
