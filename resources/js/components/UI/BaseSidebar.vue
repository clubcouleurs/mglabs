<template>
    <aside class="w-full md:w-64 bg-gray-800 md:min-h-screen">
        <div class="flex items-center justify-between bg-gray-900">
            <a href="#" class="flex items-center object-center">

                <img src ="/images/logo-mg-white.png" class="w-48 object-center">
            </a>
        ...
        <div class="px-2 py-6 md:block" :class="isOpen? 'block': 'hidden'">
            <ul>
                <li class="px-2 py-1 bg-gray-900 rounded">
                ...
                <li class="flex px-2 py-1 hover:bg-gray-900 rounded mt-2">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="mx-2 text-gray-300">Etiquettes</span>
