...
@section('content')
    <div class="min-h-screen flex items-center">
        <div class="bg-white w-full max-w-lg rounded-lg shadow overflow-hidden mx-auto">
            <div class="py-4 px-6">
                <div class="text-center font-bold text-gray-700 text-3xl content-center">
                    <img src="/images/logo-mg.jpg" class="w-64 mb-4">
                </div>
                <hr>

                <div class="mt-1 text-center font-bold text-gray-600 text-xl uppercase">Login</div>
